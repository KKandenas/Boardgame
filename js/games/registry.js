...
import * as tictactoe from "./tictactoe.js?v=33";
import * as othello from "./othello.js?v=33";
import * as backgammon from "./backgammon.js?v=33";
import * as battleship from "./battleship.js?v=33";
import * as connectfour from "./connectfour.js?v=33";
import * as checkers from "./checkers.js?v=33";
