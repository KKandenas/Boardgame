...
import * as tictactoe from "./tictactoe.js?v=28";
import * as othello from "./othello.js?v=28";
import * as backgammon from "./backgammon.js?v=28";
import * as battleship from "./battleship.js?v=28";
import * as connectfour from "./connectfour.js?v=28";
import * as checkers from "./checkers.js?v=28";
