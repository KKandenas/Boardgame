...
import * as tictactoe from "./tictactoe.js?v=24";
import * as othello from "./othello.js?v=24";
import * as backgammon from "./backgammon.js?v=24";
import * as battleship from "./battleship.js?v=24";
