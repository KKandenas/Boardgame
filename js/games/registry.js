...
import * as tictactoe from "./tictactoe.js?v=23";
import * as othello from "./othello.js?v=23";
import * as backgammon from "./backgammon.js?v=23";
import * as battleship from "./battleship.js?v=23";
