...
import * as tictactoe from "./tictactoe.js?v=16";
import * as othello from "./othello.js?v=16";
import * as backgammon from "./backgammon.js?v=16";
import * as battleship from "./battleship.js?v=16";
