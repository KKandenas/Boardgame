...
import * as tictactoe from "./tictactoe.js?v=22";
import * as othello from "./othello.js?v=22";
import * as backgammon from "./backgammon.js?v=22";
import * as battleship from "./battleship.js?v=22";
