...
import * as tictactoe from "./tictactoe.js?v=19";
import * as othello from "./othello.js?v=19";
import * as backgammon from "./backgammon.js?v=19";
import * as battleship from "./battleship.js?v=19";
