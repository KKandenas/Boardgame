...
import * as tictactoe from "./tictactoe.js?v=25";
import * as othello from "./othello.js?v=25";
import * as backgammon from "./backgammon.js?v=25";
import * as battleship from "./battleship.js?v=25";
