...
import * as tictactoe from "./tictactoe.js?v=36";
import * as othello from "./othello.js?v=36";
import * as backgammon from "./backgammon.js?v=36";
import * as battleship from "./battleship.js?v=36";
import * as connectfour from "./connectfour.js?v=36";
import * as checkers from "./checkers.js?v=36";
import * as go from "./go.js?v=36";
