...
import { getGame, DEFAULT_GAME_ID } from "./games/registry.js?v=36";
import {
    listProfiles, getOrCreateProfileByName, getStoredProfile, storeProfile, clearStoredProfile, fetchStatsLog,
} from "./profiles.js?v=36";
import { filterEntries, buildLeaderboard, buildHeadToHead } from "./stats.js?v=36";
...
export const APP_VERSION = "build 36 · 2026-08-08";
