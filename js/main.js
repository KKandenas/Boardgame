...
import { getGame, DEFAULT_GAME_ID } from "./games/registry.js?v=38";
import {
    listProfiles, getOrCreateProfileByName, getStoredProfile, storeProfile, clearStoredProfile, fetchStatsLog,
} from "./profiles.js?v=38";
import { filterEntries, buildLeaderboard, buildHeadToHead } from "./stats.js?v=38";
...
export const APP_VERSION = "build 38 · 2026-08-08";
