...
import { showScreen, renderLobby, renderGame, renderMatchOver, setError } from "./ui.js?v=15";
import { getGame } from "./games/registry.js?v=15";
...
export const APP_VERSION = "build 15 · 2026-08-03";
