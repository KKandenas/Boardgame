...
import { getGame } from "./games/registry.js?v=26";
import {
    listProfiles, getOrCreateProfileByName, getStoredProfile, storeProfile, clearStoredProfile, fetchStatsLog,
} from "./profiles.js?v=26";
import { filterEntries, buildLeaderboard, buildHeadToHead } from "./stats.js?v=26";
...
export const APP_VERSION = "build 26 · 2026-08-04";
