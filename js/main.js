...
import { getGame, DEFAULT_GAME_ID } from "./games/registry.js?v=30";
import {
    listProfiles, getOrCreateProfileByName, getStoredProfile, storeProfile, clearStoredProfile, fetchStatsLog,
} from "./profiles.js?v=30";
import { filterEntries, buildLeaderboard, buildHeadToHead } from "./stats.js?v=30";
...
export const APP_VERSION = "build 30 · 2026-08-04";
