...
import { getGame, DEFAULT_GAME_ID } from "./games/registry.js?v=37";
import {
    listProfiles, getOrCreateProfileByName, getStoredProfile, storeProfile, clearStoredProfile, fetchStatsLog,
} from "./profiles.js?v=37";
import { filterEntries, buildLeaderboard, buildHeadToHead } from "./stats.js?v=37";
...
export const APP_VERSION = "build 37 · 2026-08-08";
