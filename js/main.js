...
import { showScreen, renderLobby, renderGame, renderMatchOver, setError } from "./ui.js?v=14";
import { getGame } from "./games/registry.js?v=14";
...
export const APP_VERSION = "build 14 · 2026-08-03";
