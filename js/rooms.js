...
import { paths, dbGet, dbSet, dbRemove, dbTransact, dbListen, dbPush, registerPresence } from "./firebase.js?v=25";
import { getGame, DEFAULT_GAME_ID } from "./games/registry.js?v=25";
